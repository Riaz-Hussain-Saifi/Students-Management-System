...
console.log(chalk.cyanBright("\t Welcome to Dawn Public School Student's Management System"));
console.log(chalk.yellowBright(`*`.repeat(74)));
console.log(`\n`);
// Main function
async function main() {
...
async function enrollStudent() {
    ...
    if (parseFloat(amountPaid) >= fees) {
        console.log(chalk.green(`\n\t Enrollment successful for ${chalk.whiteBright(newStudent.name)} in ${chalk.yellowBright(newStudent.course)} of class ${chalk.blueBright(newStudent.class)}.\n`));
